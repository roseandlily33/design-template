        ...
        >
            ...
            <span
                style={{
                    ...
                    top: 14,
                    right: 14,
                    background: colours?.find((r) => r.label === "Accent")?.colors[6] || '#4caf50',
            ...
            <div style={{ padding }}>
                ...
                >
                    Journey through the ages of artistic expression.
                </p>
                <div style={{ color: colours?.find((r) => r.label === "Grey")?.colors[6] || '#888', fontSize: "0.95rem", marginBottom: 12 }}>
                    Purchased: Jan 5, 2026
                </div>
                <button
                    style={{
                        background: primaryButtonProps?.color || colours?.find((r) => r.label === "Accent")?.colors[6] || "#4caf50",
