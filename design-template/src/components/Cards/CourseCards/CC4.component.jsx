        ...
        >
            ...
            <span
                style={{
                    ...
                    top: 14,
                    right: 14,
                    background: colours?.find((r) => r.label === "Accent")?.colors[5] || '#e57373',
            ...
            <div style={{ padding }}>
                ...
                >
                    Build your skills in data analysis and visualization.
                </p>
                <div style={{ color: colours?.find((r) => r.label === "Accent")?.colors[5] || '#e57373', fontSize: "0.95rem", marginBottom: 12 }}>
                    Expired: Dec 15, 2025
                </div>
                <button
                    style={{
                        background: primaryButtonProps?.color || colours?.find((r) => r.label === "Accent")?.colors[5] || "#e57373",
