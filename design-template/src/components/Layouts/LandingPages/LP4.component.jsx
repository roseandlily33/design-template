...
const LP4 = ({ colours, fonts, borderRadius, spacingBase, spacingUnit }) => {
        ...
        >
            ...
            >
                ...
                <div style={{ display: "flex", gap: 12, width: "100%", justifyContent: "center" }}>
                    {[1, 2, 3].map((i) => (
                        <div key={i} style={{ width: 60, height: 60, borderRadius: 10, background: greyMid2 }} />
                    ))}
                </div>
            </div>
            {/* Features section */}
            ...
            {/* Testimonials section (unique block) */}
            <div
                style={{
                    width: "100%",
                    background: greyBg,
