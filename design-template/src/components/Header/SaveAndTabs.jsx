  ...
  const saveProject = async (isAutosave = false) => {
    ...
    try {
      ...
      const project = {
        ...
        borderRadius: radius,
        logo: logoUrl || null,
        primaryButton1: { ...primaryButtonStates[0] },
        primaryButton2: { ...primaryButtonStates[1] },
        primaryButton3: { ...primaryButtonStates[2] },
        secondaryButton1: { ...secondaryButtonStates[0] },
        secondaryButton2: { ...secondaryButtonStates[1] },
        secondaryButton3: { ...secondaryButtonStates[2] },
        tertiaryButton1: { ...tertiaryButtonStates[0] },
        tertiaryButton2: { ...tertiaryButtonStates[1] },
        tertiaryButton3: { ...tertiaryButtonStates[2] },
        tabButton1: { ...tabButtonStates[0] },
        tabButton2: { ...tabButtonStates[1] },
        tabButton3: { ...tabButtonStates[2] },
        fontPicker1: {
